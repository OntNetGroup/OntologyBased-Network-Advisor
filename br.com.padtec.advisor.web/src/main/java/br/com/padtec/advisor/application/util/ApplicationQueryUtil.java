...
public class ApplicationQueryUtil {
	...
	public static ArrayList<DtoInstanceRelation> GetInstanceAllRelations(InfModel infModel, String individualUri){
		ArrayList<DtoInstanceRelation> listIndividualRelations = GetInstanceRelations(infModel, individualUri);
