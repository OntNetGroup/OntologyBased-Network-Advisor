...
import br.com.padtec.advisor.controller.okco.OKCoUploadController;
...
@Controller
public class UploaderController extends OKCoUploadController implements ServletContextAware{
	...
	@Override @RequestMapping(method = RequestMethod.GET, value="/")
	...
	@Override @RequestMapping(method = RequestMethod.GET, value="/faq")
	...
	@Override @RequestMapping(value = "/login", method = RequestMethod.POST)
	...
	@Override @RequestMapping(method = RequestMethod.GET, value="/welcome")
