											  		...
											  		if(dto.PropertyType.equals(OntPropertyEnum.OBJECT_PROPERTY))
											  		{
												  		...
												  		out.println("<tr>");
													  		...
													  		out.println("<td class=\"center\">" + 
													  						"<a class=\"btn btn-info\" title=\"Manually Complete\" href=\"/tnokco/completeProperty?uriInstance="+ instance.uriEncoded + "&idDefinition=" + dto.Relation + "&type=" + "object" + "&propType=SOME" + "\"> <i class=\"icon-hand-up\"></i> </a>" + "&nbsp;" +
													  								"<a class=\"btn btn-info\" title=\"Auto Complete\" href=\"/tnokco/completePropertyAuto?uriInstance="+ instance.uriEncoded + "&idDefinition=" + dto.Relation + "&type=" + "object" + "&propType=SOME" + "\"> <i class=\"icon-cogs\"></i> </a>" +
													  					"</td>");
													...
													if(dto.PropertyType.equals(OntPropertyEnum.OBJECT_PROPERTY))
											  		{
												  		...
												  		out.println("<tr>");
													  		...
													  		out.println("<td title=\"" + dto.Target + "\">" + dto.Target.split("#")[1] + "</td>");								  		
													  		out.println("<td class=\"center\">" + 
													  				"<a class=\"btn btn-info\" title=\"Manually Complete\" href=\"/tnokco/completeProperty?uriInstance="+ instance.uriEncoded + "&idDefinition=" + dto.Relation + "&type=" + "object" + "&propType=MIN" + "\"> <i class=\"icon-hand-up\"></i> </a>" + "&nbsp;" +
											  								"<a class=\"btn btn-info\" title=\"Auto Complete\" href=\"/tnokco/completePropertyAuto?uriInstance="+ instance.uriEncoded + "&idDefinition=" + dto.Relation + "&type=" + "object" + "&propType=MIN" + "\"> <i class=\"icon-cogs\"></i> </a>" +
													  					"</td>");
													...
													if(dto.PropertyType.equals(OntPropertyEnum.OBJECT_PROPERTY))
											  		{
												  		...
												  		out.println("<td title=\"" + dto.Target + "\">" + dto.Target.split("#")[1] + "</td>");							  		
													  	out.println("<td class=\"center\">" + 
													  			"<a class=\"btn btn-info\" title=\"Manually Complete\" href=\"/tnokco/completeProperty?uriInstance="+ instance.uriEncoded + "&idDefinition=" + dto.Relation + "&type=" + "objectMax" + "&propType=MAX" + "\"> <i class=\"icon-hand-up\"></i> </a>" + "&nbsp;" +
													...
													if(dto.PropertyType.equals(OntPropertyEnum.OBJECT_PROPERTY))
											  		{
												  		...
												  		out.println("<td title=\"" + dto.Target + "\">" + dto.Target.split("#")[1] + "</td>");					  		
													  	out.println("<td class=\"center\">" + 
													  			"<a class=\"btn btn-info\" title=\"Manually Complete\" href=\"/tnokco/completeProperty?uriInstance="+ instance.uriEncoded + "&idDefinition=" + dto.Relation + "&type=" + "object" + "&propType=EXACTLY" + "\"> <i class=\"icon-hand-up\"></i> </a>" + "&nbsp;" +
										  								"<a class=\"btn btn-info\" title=\"Auto Complete\" href=\"/tnokco/completePropertyAuto?uriInstance="+ instance.uriEncoded + "&idDefinition=" + dto.Relation + "&type=" + "object" + "&propType=EXACTLY" + "\"> <i class=\"icon-cogs\"></i> </a>" +
													  					"</td>");
						...
						<%
							for (DtoDefinitionClass dto : listSomeClassDefinition) {
										  		...
										  		if(dto.PropertyType.equals(OntPropertyEnum.DATA_PROPERTY))
										  		{
											  		...
											  		out.println("<td title=\"" + dto.Target + "\">" + dto.Target.split("#")[1] + "</td>");								  		
											  		out.println("<td class=\"center\">" + 
											  				"<a class=\"btn btn-info\" href=\"/tnokco/completeProperty?uriInstance="+ instance.uriEncoded + "&idDefinition=" + dto.Relation + "&type=" + "data" + "&propType=SOME" + "\"> <i class=\"icon-hand-up\"></i> </a>" +
											  					"</td>");
												...
												if(dto.PropertyType.equals(OntPropertyEnum.DATA_PROPERTY))
										  		{
											  		...
											  		out.println("<td title=\"" + dto.Target + "\">" + dto.Target.split("#")[1] + "</td>");						  		
												  	out.println("<td class=\"center\">" + 
												  			"<a class=\"btn btn-info\" href=\"/tnokco/completeProperty?uriInstance="+ instance.uriEncoded + "&uriDefinition=" + dto.Relation + "&type=" + "data" + "&propType=MIN" + "\"> <i class=\"icon-hand-up\"></i> </a>" +
												  					"</td>");
												...
												if(dto.PropertyType.equals(OntPropertyEnum.DATA_PROPERTY))
										  		{
											  		...
											  		out.println("<td title=\"" + dto.Target + "\">" + dto.Target.split("#")[1] + "</td>");							  		
											  		out.println("<td class=\"center\">" + 
											  				"<a class=\"btn btn-info\" href=\"/tnokco/completeProperty?uriInstance="+ instance.uriEncoded + "&idDefinition=" + dto.Relation + "&type=" + "data" + "&propType=MAX" + "\"> <i class=\"icon-hand-up\"></i> </a>" +
											  					"</td>");
												...
												if(dto.PropertyType.equals(OntPropertyEnum.DATA_PROPERTY))
										  		{
											  		...
											  		out.println("<td title=\"" + dto.Target + "\">" + dto.Target.split("#")[1] + "</td>");
												  	out.println("<td class=\"center\">" + 
												  			"<a class=\"btn btn-info\" href=\"/tnokco/completeProperty?uriInstance="+ instance.uriEncoded + "&idDefinition=" + dto.Relation + "&type=" + "data" + "&propType=EXACTLY" + "\"> <i class=\"icon-hand-up\"></i> </a>" +
												  					"</td>");							  									  		
											  		out.println("</tr>");							  		
										  		}							  		
...
<div class="actions">
	<button onclick="window.location = '/tnokco/list';" type="button" class="btn btn-prev"> <i class="icon-arrow-left"></i> Back to list</button>
