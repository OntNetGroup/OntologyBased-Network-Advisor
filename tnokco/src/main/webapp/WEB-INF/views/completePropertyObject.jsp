				...
				success : function(data) {
					...
					var respContent = "<tr>" + 
						  ...
						  "<td class=\"center\">" + 
		  						...
		  						"<a class=\"btn btn-danger btn-exclude\" name=\""+ data.ns + data.name + "\" style=\"margin-left: 5px;\" href=\"#\"> <i class=\"icon-trash \"></i> </a>" +	
		  			 	  "</td>" +
					  "</tr>";
...
<div class="row" style="margin-left: 0px">
	...
	<form id="commitInstanceForm" action="commitInstance" method="POST">
		<%
			out.println("<button onclick=\"window.location = '/tnokco/details?id=" + instanceSelected.uriEncoded + "';\" type=\"button\" class=\"btn btn-prev\"> <i class=\"icon-arrow-left\"></i> Back to instance</button>");
		%>
