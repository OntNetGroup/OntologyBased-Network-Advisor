...
public class OKCoClientPost {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//funcionality = "http://localhost:8081/br/com/padtec/okco/app/listFileIncompleteness";
			funcionality = "http://localhost:8081/br/com/padtec/okco/app/completePropertyIncompleteness";
