...
public class CalculadoraEndpointCalculadoraendpointSoapBindingStub extends org.apache.axis.client.Stub implements br.ufes.inf.nemo.okco.service.CalculadoraWebService {
    ...
    public double calcular(double x, double y) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://service.okco.nemo.inf.ufes.br/", "calcular"));
