package org.oryxeditor.stencilset;
...
public class Beautifier {
	...
	String stencilsetScript = "set = "
		+ beautifier.getScriptFromFile(args[0]);
	String beautifierScript = beautifier.getScriptFromFile(ClassLoader
		.getSystemResource("org/oryxeditor/stencilset/beautifier.js")
		.getFile());
	...
	try {
	    ...
	    String result = (String) ScriptableObject
		    .callMethod(scope, "beautify", new Object[] { scope.get(
			    "set", scope) });
