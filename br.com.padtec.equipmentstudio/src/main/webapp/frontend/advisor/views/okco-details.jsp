...
<div id="row" class="row">
	<div style="padding-left: 15px; margin-bottom:20px;">	
		<button onclick="window.location = 'okco-list.htm';" style="float:left;" type="button" class="btn btn-prev"> <i class="icon-arrow-left"></i> Back to list</button>
				...
				<table class="table table-bordered table-striped">
						...
						<td>
							...
							<%
								...
								{																			
									...
									out.println("<li> <a title=\"" + i.ns + i.name  + "\" href=\"okco-details.htm?uri=" + i.uriEncoded + "\">" + i.name + "</a> </li>");
								}
							%>
							</ul>
						</td>
							...
							<%
						  		for(DtoInstanceRelation dto : InstanceListRelations)
						  		{
						  			...
						  			if(dto.Target.contains("^^"))
						  			{
						  				...
						  				out.println("<li title=\"" + dto.Property + " -> " + dto.Target + "\">" + split1 + " -> " + "<a href=\"okco-details.htm?uri=" + i.uriEncoded + "\">" + split2 + "</a>" + "</li>");
						  			}
						  		}
							%>
							</ul>
					...
					<tr>
						...
						<td>
							<ul style="margin: 0">
								<%
									out.println("<li><a class=\"btn btn-success\" target=\"_blank\" href=\"okco-visualizer.htm?typeView=IN&uri=" + instance.uriEncoded + "\"> <i class=\"icon-zoom-in\"></i> </a> To "+instance.name+"</li>");
									out.println("<li style=\"margin-top:3px;\"><a class=\"btn btn-success\" target=\"_blank\" href=\"okco-visualizer.htm?typeView=OUT&uri=" + instance.uriEncoded + "\"> <i class=\"icon-zoom-in\"></i> </a> From "+instance.name+"</li>");
								%>
							</ul>
						</td>
					<tr>
						...
						<%	
							...
							if(instance.ListCompleteClasses.size() > 0)
							{
								for (DtoCompleteClass dto : instance.ListCompleteClasses)
								{
									...
									{
										out.println("<form class=\"completeClassForm\" id=\"completeClassForm_"+ countForm + "\" action=\"classifyInstanceClasses.htm\" method=\"POST\">");
					...
					<div class="tab-pane" id="properties">
							...
							if(ListSpecializationProperties.size() > 0)
							{
								...
								for (DtoPropertyAndSubProperties dto : ListSpecializationProperties) 
								{
									...
									{
										out.println("<form id=\"completePropertyForm_"+ countDtos + "\" class=\"completePropertyForm\" action=\"classifyInstanceProperty.htm\" method=\"POST\">");
						  		...
						  		if(dto.PropertyType.equals(OntPropertyEnum.OBJECT_PROPERTY))
						  		{
							  		...
							  		out.println("<tr>");
								  		...
								  		out.println("<td class=\"actions\">" + 
					  						"<a class=\"btn btn-info\" title=\"Manually Complete\" href=\"completeProperty.htm?uriInstance="+ instance.uriEncoded + "&idDefinition=" + dto.uriRelationEncoded + "&type=" + "object" + "&propType=SOME" + "\"> <i class=\"icon-hand-up\">&nbsp;Manually Complete</i> </a>" + "&nbsp;");
					  					
								  		if(!dto.status.equals(DtoStatus.SATISFIED)) 
								  		{
				  							out.println("<a class=\"btn btn-info\" title=\"Auto Complete\" href=\"completePropertyAuto?uriInstance="+ instance.uriEncoded + "&idDefinition=" + dto.uriRelationEncoded + "&type=" + "object" + "&propType=SOME" + "\"> <i class=\"icon-cogs\">&nbsp;Auto Complete</i> </a>");
								  		}
						...
						String stateData = "label label-important";
							...
							for (DtoDefinitionClass dto : listSomeClassDefinition) {
										  		...
										  		if(dto.PropertyType.equals(OntPropertyEnum.DATA_PROPERTY))
										  		{
											  		...
											  		out.println("<td class=\"actions\">" + 
											  				"<a class=\"btn btn-info\" href=\"completeProperty?uriInstance="+ instance.uriEncoded + "&idDefinition=" + dto.uriRelationEncoded + "&type=" + "data" + "&propType=SOME" + "\"> <i class=\"icon-hand-up\">&nbsp;Manually Complete</i> </a>" +
											  					"</td>");
												...
												if(dto.PropertyType.equals(OntPropertyEnum.DATA_PROPERTY))
										  		{
												  	...
												  	out.println("<td class=\"actions\">" + 
												  			"<a class=\"btn btn-info\" href=\"completeProperty?uriInstance="+ instance.uriEncoded + "&idDefinition=" + dto.uriRelationEncoded + "&type=" + "data" + "&propType=MIN" + "\"> <i class=\"icon-hand-up\">&nbsp;Manually Complete</i> </a>" +
												  					"</td>");
												...
												if(dto.PropertyType.equals(OntPropertyEnum.DATA_PROPERTY))
										  		{
											  		...
											  		out.println("<td class=\"actions\">" + 
											  				"<a class=\"btn btn-info\" href=\"completeProperty?uriInstance="+ instance.uriEncoded + "&idDefinition=" + dto.uriRelationEncoded + "&type=" + "data" + "&propType=MAX" + "\"> <i class=\"icon-hand-up\">&nbsp;Manually Complete</i> </a>" +
											  					"</td>");
												...
												if(dto.PropertyType.equals(OntPropertyEnum.DATA_PROPERTY))
										  		{
												  	...
												  	out.println("<td class=\"actions\">" + 
												  			"<a class=\"btn btn-info\" href=\"completeProperty?uriInstance="+ instance.uriEncoded + "&idDefinition=" + dto.uriRelationEncoded + "&type=" + "data" + "&propType=EXACTLY" + "\"> <i class=\"icon-hand-up\">&nbsp;Manually Complete</i> </a>" +
												  					"</td>");							  									  		
											  		out.println("</tr>");							  		
										  		}							  		
...
<div class="actions">
	<button onclick="window.location = 'okco-list.htm';" type="button" class="btn btn-prev"> <i class="icon-arrow-left"></i> Back to list</button>
