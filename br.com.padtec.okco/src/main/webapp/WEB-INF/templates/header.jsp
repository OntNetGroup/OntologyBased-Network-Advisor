			...
			<div class="container">
				...
				<div class="row">
					<a class="navbar-brand col-lg-2 col-sm-1 col-xs-12"
						href="/br.com.padtec.okco/welcome">
			...
			<div id="sidebar-left" class="col-lg-2 col-sm-1">
				...
				<div class="nav-collapse sidebar-nav collapse navbar-collapse bs-navbar-collapse">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="/br.com.padtec.okco/welcome"><i class="icon-bar-chart"></i><span
								class="hidden-sm"> Start Page</span></a></li>
						<li><a href="/br.com.padtec.okco/list"><i class="icon-ok-circle"></i><span
								class="hidden-sm"> Instances</span></a></li>
						<li><a href="/br.com.padtec.okco/getModel" class=""><i class="icon-save"></i><span
								class="hidden-sm"> Save OWL File</span></a></li>
						<li><a href="/br.com.padtec.okco/faq" class=""><i class="icon-eye-open"></i><span
