...
public class Test {
	...
	public void setQtShortPathsFromConsole() {
		this.qtShortPaths = ConsoleUtil.getOptionFromConsole("Choose the number of paths (enter 0 to show all)", 0, Integer.MAX_VALUE,0, false);
	}
	...
	public void setMaxPathSizeFromConsole() {
		this.maxPathSize = ConsoleUtil.getOptionFromConsole("Choose the maximum number of interfaces in a path (enter 0 for no limit)", 0, Integer.MAX_VALUE,0, false);
	}
