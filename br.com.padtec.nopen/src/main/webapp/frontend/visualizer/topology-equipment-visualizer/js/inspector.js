...
//			},			
			...
			'octk-nim':{
				inputs:{
					...
					timdetmode:{type:'select',options:['off','dapi','sapi','both'],index:5,label:'Operational State',attrs:{'label':{'data-tooltip' : 'This attribute indicates the mode of the Trace<br> Identifier Mismatch (TIM) Detection function. Valid<br> values are: off, dapi, sapi, both. This attribute is<br> read-write.'}}},
					...
					currentproblemlist:{type: "number",min: 0,max: 2147483647,label: "Current Problem List",attrs:{"input":{"data-tooltip": "This attribute indicates the failure conditions of the entity.<br>Possible values of this attribute include decimal <br> numbers between 1 and 31, representing:<br>1)no defect;<br>2)TIM (Trail Trace Identifier Mismatch);<br>3) DEG (Signal Degraded);<br>4) BDI (Backward Defect Indication);<br>5) SSF (Server Signal Fail).<br>This attribute is read-only." }}},
				},
				label:{}
			},
			'oduk-client-ctp':{
				inputs:{
					...
					currentproblemlist:
					{
						...
						attrs:
						{
							...
							{
								"data-tooltip": 
									"This attribute indicates the failure conditions of the entity.<br>Possible values of this attribute include decimal <br> numbers between 1 and 31, representing:<br>1)no defect;<br>2)TIM (Trail Trace Identifier Mismatch);<br>3) DEG (Signal Degraded);<br>4) BDI (Backward Defect Indication);<br>5) SSF (Server Signal Fail).<br>This attribute is read-only." 
							}
						}			
					},
				},
