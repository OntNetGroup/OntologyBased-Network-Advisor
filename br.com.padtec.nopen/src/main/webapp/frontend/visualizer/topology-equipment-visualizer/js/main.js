...
//				var elementname = opt[i].name;
//				var input = "{myproperty: { type: 'range', min: 0, max: 30, defaultValue: 1, group: 'mydata', index: 1 }, attrs: {text: {text: { type: 'textarea', group: 'text', index: 1 },'font-size': { type: 'number', group: 'text', index: 2 }}}";
//				var group = "{mydata: { label: 'My Data', index: "+i+" },";
//				a = a+input;
//				b = b+group;
//				console.log(a);
//				console.log(b);
