...
//				console.log(opt[i]);
				...
				var elementname = index;
				var input = "k_"+elementname+":{type:'range',min:'1',max:'3',step:'1',index:1,group:'odukclientctp_"+elementname+"',label:'k',attrs:{'label': {'data-tooltip' : 'This attribute specifies the index k that is used<br> to represent a supported bit rate and the different<br> versions of OPUk, ODUk and OTUk. Valid values for<br> this attribute are integers 1, 2 and 3.<br>k = 1 represents an approximate bit rate of 2.5 Gbit/s;<br>k = 2 represents an approximate bit rate of 10 Gbit/s; and<br>k = 3 represents an approximate bit rate of 40 Gbit/s.<br>This attribute is read-only.'}}},	adaptationtype:{type: 'number',	min: 0,max: 2147483647,index:2,group:'odukclientctp_"+elementname+"',label: 'Adaptation Type',attrs:{'input':{'data-tooltip':'This attribute indicates the type of the supported<br> adaptation function at the interface port. Valid<br> values of this attribute include integers between 1 and 63, representing:<br>1) CBR;<br>2) ATMvp;<br>3) GFP;<br>4) NULL;<br>5) PRBS;<br>6) RSn.<br>This attribute is read-only.'}}},sinadaptactive:{type: 'toggle',index:3,group:'odukclientctp_"+elementname+"',label: 'Sink Adapt Active',	attrs:{'input':{'data-tooltip':'This attribute allows for activation or<br> deactivation the sink adaptation function. The value<br> of TRUE means active. This attribute is read-write.'}}},sourceadaptactive_"+elementname+":{type: 'toggle',index:4,group:'odukclientctp_"+elementname+"',label: 'Source Adapt Active',attrs:{'input':{'data-tooltip':'This attribute allows for activation or deactivation<br> the source adaptation function. The value of TRUE<br> means activate. This attribute is read-write.'}}},payloadtypeac:{type: 'number',min: 0,max: 2147483647,index:5,group:'odukclientctp_"+elementname+"',label: 'Payload Type AC',attrs:{'input':{'data-tooltip':'This attribute indicates the actual payload type<br> signal received. This attribute is read-only.'}}},operationalstate_"+elementname+"_"+elementname+":{type: 'select',options: ['enabled','disabled'],index:6,group:'odukclientctp_"+elementname+"',label:'Operational State',attrs:{'label':{'data-tooltip':'This attribute is generally defined in ITU-T Rec.<br> X.731 and the behaviour description for<br> operationalstate_"+elementname+"_"+elementname+" in ITU-T Rec. M.3100.<br>Possible Values – Enabled and Disabled. See ITU-T<br>Recs. X.731 and M.3100 for details.<br>Default Value – Actual state of resource at the time<br>the object is created. If there is a period of time<br>during the initialization process where the<br>operational state is unknown, then the resource will<br> be considered disabled until initialization has<br>completed and the state updated accordingly.<br>Constraints to Provisioning – N/A.<br>Effect of Change in Value – See ITU-T Recs. X.731 and M.3100.<br>This attribute is read-only.'}}},directionality_"+elementname+":{type: 'select',options: ['sink','source','bidirectional'],index:7,group:'odukclientctp_"+elementname+"',label: 'directionality ',attrs:{'label':{'data-tooltip':'This attribute indicates the directionality of the<br> termination point. Valid values are sink, source,<br> and bidirectional. This attribute is read-only.'}}},currentproblemlist_"+elementname+":{type: 'number',min: 1,max: 15,index:8,group:'odukclientctp_"+elementname+"',label: 'Current Problem List',attrs:{'input':{'data-tooltip':'This attribute indicates the failure conditions of the entity.<br>Possible values of this attribute include decimal <br> numbers between 1 and 31, representing:<br>1)no defect;<br>2)TIM (Trail Trace Identifier Mismatch);<br>3) DEG (Signal Degraded);<br>4) BDI (Backward Defect Indication);<br>5) SSF (Server Signal Fail).<br>This attribute is read-only.' }}},";
				...
				var elementname = index;
				var input = "operationalstate_"+elementname+":{'type': 'select','options': ['enabled','disabled'],group:'oduktttp_"+elementname+"','label': 'Operational State','attrs':{'input':{'data-tooltip':'This attribute is generally defined in ITU-T Rec.<br>X.731 and the behaviour description for<br>operationalstate_"+elementname+"_"+elementname+" in ITU-T Rec. M.3100.<br>Possible Values – Enabled and Disabled. See ITU-T<br>Recs. X.731 and M.3100 for details.<br>Default Value – Actual state of resource at the time<br>the object is created. If there is a period of time<br>during the initialization process where the<br>operational state is unknown, then the resource will<br>be considered disabled until initialization has<br>completed and the state updated accordingly.<br>Constraints to Provisioning – N/A.<br>Effect of Change in Value – See ITU-T Recs. X.731 and M.3100.<br>This attribute is read-only.'}}},'directionality':{'type': 'select','options': ['sink','source','bidirectional'],group:oduktttp_"+elementname+",'label': 'directionality','attrs':{'input':{'data-tooltip':'This attribute indicates the directionality of the<br>termination point. Valid values are sink, source,<br>and bidirectional. This attribute is read-only.'}}},'tcm-field':{'type': 'range','min': 1,'max': 6,'step': 1,group:oduktttp_"+elementname+",'label': 'TCM Field','attrs':{'input':{'data-tooltip':'This attribute indicates the tandem connection<br>monitoring field of the ODUk OH. Valid values are<br>integers from 1 to 6. This attribute is read-only.'}}},'tx-ti':{'type': 'text',group:oduktttp_"+elementname+",'label': 'TX TI','attrs':{'input':{'data-tooltip':'The Trail Trace Identifier (TTI) information,<br>provisioned by the managing system at the<br>termination source, to be placed in the TTI overhead<br>position of the source of a trail for transmission.<br>This attribute is read-write.'}}},'ex-dapi':{'type': 'text',group:oduktttp_"+elementname+",'label': 'EX DAPI','attrs':{'input':{'data-tooltip':'The Expected Destination Access Point Identifier<br> (ExDAPI), provisioned by the managing system, to be<br> compared with the TTI accepted at the overhead<br> position of the sink for the purpose of checking the<br>integrity of connectivity. This attribute is<br>read-write.'}}},'ex-sapi':{'type': 'text',group:oduktttp_"+elementname+",'label': 'EX SAPI','attrs':{'input':{'data-tooltip': 'The Expected Source Access Point Identifier<br> (ExSAPI), provisioned by the managing system, to be<br> compared with the TTI accepted at the overhead<br> position of the sink for the purpose of checking the<br>integrity of connectivity. This attribute is<br>read-write.'}}},'ac-ti':{'type': 'text',group:oduktttp_"+elementname+",'label': 'AC TI','attrs':{'input':{'data-tooltip':'The Trail Trace Identifier (TTI) information<br> recovered (Accepted) from the TTI overhead position<br>at the sink of a trail. This attribute is read-only.'}}},'tim-det-mode':{'type': 'select','option': ['off','dapi','sapi','both'],group:oduktttp_"+elementname+",'label': 'TIM DET Mode','attrs':{'input':{'data-tooltip':'This attribute indicates the mode of the Trace<br> Identifier Mismatch (TIM) Detection function. Valid<br> values are: off, dapi, sapi, both. This attribute is<br> read-write.'}}},'tim-act-disabled':{'type': 'toggle',group:oduktttp_"+elementname+",'label': 'TIM ACT Disabled','attrs':{'input':{'data-tooltip':'This attribute provides the control capability for the<br>managing system to enable or disable the Consequent<br> Action function when detecting Trace Identifier Mismatch<br>(TIM) at the trail termination sink. The value of TRUE<br>means disabled. This attribute is read-write.'}}},'deg-thr':{'type': 'number','min': 0,'max': 2147483647,group:oduktttp_"+elementname+",'label': 'DEG THR','attrs':{'input':{'data-tooltip': 'This attribute indicates the threshold level for<br> declaring a performance monitoring (PM) Second to be<br> bad. A PM Second is declared bad if the percentage<br> of detected errored blocks in that second is greater<br> than or equal to the specified threshold level.<br> Valid values are integers in units of percentages.<br>This attribute is read-write.'}}},'deg-m':{'type': 'number','min': 0,'max': 2147483647,group:oduktttp_"+elementname+",'label': 'DEG M','attrs':{'input':{'data-tooltip':'This attribute indicates the threshold level for<br> declaring a Degraded Signal defect (dDEG). A dDEG<br> shall be declared if DegM consecutive bad PM Seconds<br> are detected. This attribute is read-write.'}}},'admin-state-source':{'type': 'select','option': ['locked','normal'],group:oduktttp_"+elementname+",'label': 'Admin State Source','attrs':{'input':{'data-tooltip':'This attribute provides the capability to provision<br>the LOCK signal at the sink, which is one of the<br>ODUk maintenance signals. Valid values for this<br>attribute are Locked and Normal. When a Tandem <br>Connection endpoint is set to admin state locked, it<br> will insert the ODUk-LCK signal in the downstream<br>direction.'}}},'mode-sink':{'type': 'select','options': ['operational','monitor','transparent'],group:oduktttp_"+elementname+",'label': 'Mode Sink','attrs':{'input':{'data-tooltip': 'This attribute specifies the TCM mode at the entity.<br>Valid values are: Operational, Monitor, and Transparent.'}}},'mode-source':{'type': 'select','options': ['operational','monitor','transparent'],group:oduktttp_"+elementname+",'label': 'Mode Source','attrs':{'input':{'data-tooltip':'This attribute specifies the TCM mode at the entity.<br>Valid values are: Operational, Monitor, and Transparent.'}}},'ac-status-sink':{group:oduktttp_"+elementname+",'type': 'select','options': ['no-source-tc','in-use-without-iae','in-use-with-ia', 'reserved-for-future-internacional-standardizartion-one','reserved-for-future-internacional-standardizartion-two','aintenance-signal-oduk-lck','maintenance-signal-oduk-oci','maintenance-signal-oduk-ais'],'label': 'AC Status Sink','attrs':{'input':{'data-tooltip':'This attribute indicates the status of the accepted<br>TCM. This attribute is read-only'}}},'ac-status-source':{group:oduktttp_"+elementname+",'type': 'select','option': ['no-source-tc','in-use-without-iae','in-use-with-ia', 'reserved-for-future-internacional-standardizartion-one','reserved-for-future-internacional-standardizartion-two','aintenance-signal-oduk-lck','maintenance-signal-oduk-oci','maintenance-signal-oduk-ais'],'label': 'AC Status Source','attrs':{'input':{'data-tooltip':'This attribute indicates the status of the accepted<br>TCM. This attribute is read-only'}}},'codirectional':{group:oduktttp_"+elementname+",'type': 'toggle','label': 'Codirectional','attrs':{'input':{'data-tooltip': 'This attribute specifies the directionality of the<br>ODUkT TP with respect to the associated ODUk_CTP.<br>The value of TRUE means that the sink part of the<br>ODUkT TP terminates the same signal direction as the<br>sink part of the ODUk_CTP. The Source part behaves<br>similarly. This attribute is meaningful only on<br> objects instantiated under ODUk_CTP, and at least<br>one among ODUk_CTP and the subordinate object has<br>directionality equal to Bidirectional. This<br>attribute is read-only. '}}},'current-problem-list':{group:oduktttp_"+elementname+",'type': 'number','min': 1,'max': 127,'label': 'Current Problem List','attrs':{'input':{'data-tooltip':'This attribute indicates the failure conditions of<br>the entity. Possible values of this attribute include decimal numbers between 1 and 127, representing:<br>1) no defect;<br>2) OCI (Open Connection Indication);<br>3) LCK (Locked);<br>4) TIM (Trail Trace Identifier Mismatch);<br>5) DEG (Signal Degraded);<br>6) BDI (Backward Defect Indication);<br>7) SSF (Server Signal Fail).<br>This attribute is read-only.'}}},";
