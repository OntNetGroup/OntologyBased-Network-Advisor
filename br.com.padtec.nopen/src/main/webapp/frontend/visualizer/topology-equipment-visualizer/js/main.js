...
//				console.log(opt[i]);
				...
				if(element === "och-client-ctp-grouping"){
					...
					var group = "ochclientctp"+elementname+": { label: 'OCH Client CTP "+elementname+"'},";
				...
				if(element === "och-ttp-grouping"){
					...
					var group = "ochttp"+elementname+": { label: 'OCH TTP "+elementname+"' },";
				...
				var group = "ochrctp"+elementname+": { label: 'OCHr CTP "+elementname+"' },";
				...
				var group = "ochrttp"+elementname+": { label: 'OCHr TTP "+elementname+"' },";
				...
				var group = "octknim"+elementname+": { label: 'OCTk NIM "+elementname+"' },";
				...
				var group = "odukclientctp"+elementname+": { label: 'ODUk client CTP "+elementname+"' },";
				...
				var group = "odukctp"+elementname+": { label: 'ODUk CTP "+elementname+"'  },";
				a = a+input;
				b = b+group;
				console.log(a);
				console.log(b);
				...
				var group = "oduknim"+elementname+": { label: 'ODUk NIM "+elementname+"' },";
				a = a+input;
				b = b+group;
				console.log(a);
				console.log(b);
				...
				var group = "odukttp"+elementname+": { label: 'ODUk TTP "+elementname+"' },";
				a = a+input;
				b = b+group;
				console.log(a);
				console.log(b);
				...
				var group = "oduktnim"+elementname+": { label: 'ODUkt NIM "+elementname+"' },";
				...
				var group = "omsnctp"+elementname+": { label: 'OMSn CTP "+elementname+"' },";
				a = a+input;
				b = b+group;
				console.log(a);
				console.log(b);
				...
				var group = "{omsnttp"+elementname+": { label: 'OMSn ttp "+elementname+"'},";
				a = a+input;
				b = b+group;
				console.log(a);
				console.log(b);
				...
				var group = "{omnsnp"+elementname+": { label: 'OMSnp "+elementname+"'},";
				a = a+input;
				b = b+group;
				console.log(a);
				console.log(b);
				...
				var group = "{opsnttp"+elementname+": { label: 'OPSn ttp "+elementname+"' },";
				a = a+input;
				b = b+group;
				console.log(a);
				console.log(b);
				...
				var group = "otmnentity"+elementname+": { label: 'OTMn entity "+elementname+"' },";
				a = a+input;
				b = b+group;
				console.log(a);
				console.log(b);
				...
				var group = "otsnttp"+elementname+": { label: 'OTSn TTP "+elementname+"' },";
				a = a+input;
				b = b+group;
				console.log(a);
				console.log(b);
				...
				var group = "otukctp"+elementname+": { label: 'OTUk CTP "+elementname+"' },";
				a = a+input;
				b = b+group;
				console.log(a);
				console.log(b);
				...
				var group = "otukttp"+elementname+": { label: 'OTUk ttp "+elementname+"' },";
				a = a+input;
				b = b+group;
				console.log(a);
				console.log(b);
...
//				var ttf = {
//						"type": "TTF",
//						"id": "otuk-ttp-grouping",
//						"name": "TTF_0"
//				}
//				opt.push(ttf);
//				var af = {
//						"type": "AF",
//						"id": "otsn-ttp-grouping",
//						"name": "AF_2"
//				}
//				opt.push(af);
