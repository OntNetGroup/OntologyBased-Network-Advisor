...
//				console.log(opt[i]);
				...
				if(element === "och-ttp-grouping"){
					var elementname = index;
					var input = "directionality"+elementname+": {type: 'select' , options:['sink','source','bidirectional'],index: 1 ,group:'ochttp"+elementname+"' , label: 'directionality ', attrs: { 'label': {'data-tooltip': 'This attribute indicates the directionality of the<br>termination point. Valid values are sink, source,<br>and bidirectional. This attribute is read-only.'}}},operationalstate"+elementname+""+elementname+": {type: 'select' , options:['enabled','disabled'],index: 2,group:'ochttp"+elementname+"' , label: 'Operational State', attrs: { 'label': {'data-tooltip': 'This attribute is generally defined in ITU-T Rec.<br>X.731 and the behaviour description for<br>operationalstate"+elementname+" in ITU-T Rec. M.3100.<br>Possible Values – Enabled and Disabled. See ITU-T<br>Recs. X.731 and M.3100 for details.<br>Default Value – Actual state of resource at the time<br>the object is created. If there is a period of time<br>during the initialization process where the<br>operational state is unknown, then the resource will<br>be considered disabled until initialization has<br>completed and the state updated accordingly.<br>Constraints to Provisioning – N/A.<br>Effect of Change in Value – See ITU-T Recs. X.731 and M.3100.<br>This attribute is read-only.'}}},adiministrativestate"+elementname+": {type: 'select', options:['unlocked','locked','shutting-down'],index:3,group:'ochttp"+elementname+"',label:'Administrative State', attrs: {'label': {'data-tooltip': 'This attribute is generally defined in ITU-T Rec.<br>X.731 and the behaviour description for<br>administrativeState in ITU-T Rec. M.3100.<br>Possible Values − Unlocked, Locked, and Shutting<br>Down. See ITU-T Recs. X.731 and M.3100.<br>Default Value − Unlocked (If there is a need that<br>can be identified for locking this resource, this<br>decision will need to be re-evaluated).<br>Constraints to Provisioning − Constrained to<br>Unlocked (If there is a need that can be identified<br>for locking this resource, this decision will need<br>to be re-evaluated).<br>Effect of Change in Value − N/A (If there is a need<br>that can be identified for locking this resource,<br>this decision will need to be re-evaluated).<br>This attribute is read-write.'}}},currentproblemlist"+elementname+":{type: 'number', min: '1', max: '63' ,index: 4,group:'ochttp"+elementname+"' , label: 'Current Problem List', attrs: {'input' : {'data-tooltip': 'This attribute indicates the failure conditions of<br>the entity. Possible values of this attribute include decimal numbers between 1 and 63, representing:<br>1) no defect;<br>2) LOS-P (Loss of Signal − Payload);<br>3) OCI (Open Connection Indicator);<br>4) SSF-P (Server Signal failure − Payload);<br>5) SSF-O (Server Signal failure − Overhead);<br>6) SSF (Server Signal failure).<br>This attribute is read-only.' }}},";
				...
				var elementname = index;
				var input = "directionality"+elementname+": {type: 'select' , options:['sink','source','bidirectional'],index: 1,group:'ochrttp"+elementname+"' , label: 'directionality ', attrs: { 'label': {'data-tooltip': 'This attribute indicates the directionality of the<br>termination point. Valid values are sink, source,<br>and bidirectional. This attribute is read-only.'}}},operationalstate"+elementname+""+elementname+": {type: 'select' , options:['enabled','disabled'],index: 2 ,group:'ochrttp"+elementname+"', label: 'Operational State', attrs: { 'label': {'data-tooltip': 'This attribute is generally defined in ITU-T Rec.<br>X.731 and the behaviour description for<br>operationalstate"+elementname+""+elementname+" in ITU-T Rec. M.3100.<br>Possible Values – Enabled and Disabled. See ITU-T<br>Recs. X.731 and M.3100 for details.<br>Default Value – Actual state of resource at the time<br>the object is created. If there is a period of time<br>during the initialization process where the<br>operational state is unknown, then the resource will<br>be considered disabled until initialization has<br>completed and the state updated accordingly.<br>Constraints to Provisioning – N/A.<br>Effect of Change in Value – See ITU-T Recs. X.731 and M.3100.<br>This attribute is read-only.'}}},adiministrativestate"+elementname+": {type: 'select', options:['unlocked','locked','shutting-down'],index:3,group:'ochrttp"+elementname+"',label:'Administrative State', attrs: {'label': {'data-tooltip': 'This attribute is generally defined in ITU-T Rec.<br>X.731 and the behaviour description for<br>administrativeState in ITU-T Rec. M.3100.<br>Possible Values − Unlocked, Locked, and Shutting<br>Down. See ITU-T Recs. X.731 and M.3100.<br>Default Value − Unlocked (If there is a need that<br>can be identified for locking this resource, this<br>decision will need to be re-evaluated).<br>Constraints to Provisioning − Constrained to<br>Unlocked (If there is a need that can be identified<br>for locking this resource, this decision will need<br>to be re-evaluated).<br>Effect of Change in Value − N/A (If there is a need<br>that can be identified for locking this resource,<br>this decision will need to be re-evaluated).<br>This attribute is read-write.'}}},currentproblemlist"+elementname+":{type: 'number', min: '1', max: '63' ,index: 4 ,group:'ochrttp"+elementname+"' , label: 'Current Problem List', attrs: {'input' : {'data-tooltip': 'This attribute indicates the failure conditions of<br>the entity. Possible values of this attribute include decimal numbers between 1 and 63, representing:<br>1) no defect;<br>2) LOS-P (Loss of Signal − Payload);<br>3) OCI (Open Connection Indicator);<br>4) SSF-P (Server Signal failure − Payload);<br>5) SSF-O (Server Signal failure − Overhead);<br>6) SSF (Server Signal failure).<br>This attribute is read-only.' }}},";
				...
				var elementname = index;
				var input = "k"+elementname+":{type:'range',min:'1',max:'3',step:'1',index:1,group:'octknim"+elementname+"',label:'k',attrs:{'label': {'data-tooltip' : 'This attribute specifies the index k that is used<br> to represent a supported bit rate and the different<br> versions of OPUk, ODUk and OTUk. Valid values for<br> this attribute are integers 1, 2 and 3.<br>k = 1 represents an approximate bit rate of 2.5 Gbit/s;<br>k = 2 represents an approximate bit rate of 10 Gbit/s; and<br>k = 3 represents an approximate bit rate of 40 Gbit/s.<br>This attribute is read-only.'}}},operationalstate"+elementname+""+elementname+": {type: 'select' , options:['enabled','disabled'],index: 2 ,group:'octknim"+elementname+"', label: 'Operational State', attrs: { 'label': {'data-tooltip': 'This attribute is generally defined in ITU-T Rec.<br> X.731 and the behaviour description for<br> operationalstate"+elementname+""+elementname+" in ITU-T Rec. M.3100.<br>Possible Values – Enabled and Disabled. See ITU-T<br> Recs. X.731 and M.3100 for details.<br>Default Value – Actual state of resource at the time<br> the object is created. If there is a period of time<br> during the initialization process where the<br> operational state is unknown, then the resource will<br> be considered disabled until initialization has<br> completed and the state updated accordingly.<br>Constraints to Provisioning – N/A.<br>Effect of Change in Value – See ITU-T Recs. X.731 and M.3100.<br>This attribute is read-only.'}}},exdapi"+elementname+":{type:'text',index:3,group:'octknim"+elementname+"',label:'EX DAPI',attrs:{'input':{'data-tooltip':'The Expected Source Access Point Identifier<br> (ExSAPI), provisioned by the managing system, to be<br> compared with the TTI accepted at the overhead<br> position of the sink for the purpose of checking the<br> integrity of connectivity. This attribute is<br> read-write.'}}},acti"+elementname+":{type:'text',index:4,group:'octknim"+elementname+"',label:'AC TI',attrs:{'input':{'data-tooltip':'The Trail Trace Identifier (TTI) information<br> recovered (Accepted) from the TTI overhead position<br> at the sink of a trail. This attribute is read-only.'}}},timdetmode"+elementname+":{type:'select',options:['off','dapi','sapi','both'],index:5,group:'octknim"+elementname+"',label:'Operational State',attrs:{'label':{'data-tooltip' : 'This attribute indicates the mode of the Trace<br> Identifier Mismatch (TIM) Detection function. Valid<br> values are: off, dapi, sapi, both. This attribute is<br> read-write.'}}},timactdisabled"+elementname+":{type:'togle',index:6,group:'octknim"+elementname+"',label:'TIM ACT Disabled',attrs:{'input':{'data-tooltip':'This attribute provides the control capability for the<br> managing system to enable or disable the Consequent<br> Action function when detecting Trace Identifier Mismatch<br> (TIM) at the trail termination sink. The value of TRUE<br> means disabled. This attribute is read-write.'}}},degthr"+elementname+":{type: 'number',min: 0,max: 2147483647,index: 7,group:'octknim"+elementname+"',label: 'DEG THR',	attrs:{'input':{'data-tooltip': 'This attribute indicates the threshold level for<br> declaring a performance monitoring (PM) Second to be<br> bad. A PM Second is declared bad if the percentage<br> of detected errored blocks in that second is greater<br> than or equal to the specified threshold level.<br> Valid values are integers in units of percentages.<br> This attribute is read-write.'}}},degm"+elementname+":{type: 'number',min: 0,max: 2147483647,index:8,group:'octknim"+elementname+"',label: 'DEG M',attrs:{'input':{'data-tooltip': 'This attribute indicates the threshold level for<br> declaring a Degraded Signal defect (dDEG). A dDEG<br> shall be declared if DegM consecutive bad PM Seconds<br> are detected. This attribute is read-write.'}}},currentproblemlist"+elementname+":{type: 'number',min: 0,max: 2147483647,index:9,group:'octknim"+elementname+"',label: 'Current Problem List',attrs:{'input':{'data-tooltip': 'This attribute indicates the failure conditions of the entity.<br>Possible values of this attribute include decimal <br> numbers between 1 and 31, representing:<br>1)no defect;<br>2)TIM (Trail Trace Identifier Mismatch);<br>3) DEG (Signal Degraded);<br>4) BDI (Backward Defect Indication);<br>5) SSF (Server Signal Fail).<br>This attribute is read-only.' }}},";
				...
				var elementname = index;
				var input = "operationalstate"+elementname+""+elementname+":{type: 'select',options: ['enabled','disabled'],index:1,group:'odukctp"+elementname+"',label: 'Operational State',attrs:{'input':{'data-tooltip':'This attribute is generally defined in ITU-T Rec.<br> X.731 and the behaviour description for<br> operationalstate"+elementname+" in ITU-T Rec. M.3100.<br>Possible Values – Enabled and Disabled. See ITU-T<br> Recs. X.731 and M.3100 for details.<br> Default Value – Actual state of resource at the time<br> the object is created. If there is a period of time<br> during the initialization process where the<br> operational state is unknown, then the resource will<br>  be considered disabled until initialization has<br>  completed and the state updated accordingly.<br> Constraints to Provisioning – N/A.<br> Effect of Change in Value – See ITU-T Recs. X.731 and M.3100.<br> This attribute is read-only.'}}},directionality"+elementname+":{type: 'select',options: ['sink','source','bidirectional'],index:2,group:'odukctp"+elementname+"',label: 'directionality ',attrs:{'label':{'data-tooltip':'This attribute indicates the directionality of the<br> termination point. Valid values are sink, source,<br> and bidirectional. This attribute is read-only.'}}},currentproblemlist"+elementname+":{type: 'number',min: 1,max: 15,index:3,group:'odukctp"+elementname+"',label: 'Current Problem List',attrs:{'input':{'data-tooltip':'This attribute indicates the failure conditions of the entity.<br>Possible values of this attribute include decimal <br> numbers between 1 and 31, representing:<br>1)no defect;<br>2)TIM (Trail Trace Identifier Mismatch);<br>3) DEG (Signal Degraded);<br>4) BDI (Backward Defect Indication);<br>5) SSF (Server Signal Fail).<br>This attribute is read-only.' }}},";
				var group = "odukctp"+elementname+": { label: 'ODUk CTP "+elementname+"', index: "+i+"  },";
				a = a+input;
				b = b+group;
				i++;
				console.log(a);
				...
				var elementname = index;
				var input = "k"+elementname+":{type: 'range',min: 1,max: 3,step: 1,index: 1,group:'oduknim"+elementname+"',label: 'k',attrs:{'input':{'data-tooltip':'This attribute specifies the index k that is used<br> to represent a supported bit rate and the different<br> versions of OPUk, ODUk and OTUk. Valid values for<br> this attribute are integers 1, 2 and 3.<br>k = 1 represents an approximate bit rate of 2.5 Gbit/s;<br>k = 2 represents an approximate bit rate of 10 Gbit/s; and<br>k = 3 represents an approximate bit rate of 40 Gbit/s.<br>This attribute is read-only.' }}},operationalstate"+elementname+""+elementname+":{type: 'select',options: ['enabled','disabled'],label: 'Operational State',attrs:{'label':{'data-tooltip': 'This attribute is generally defined in ITU-T Rec.<br> X.731 and the behaviour description for<br> operationalstate"+elementname+""+elementname+" in ITU-T Rec. M.3100.<br>Possible Values – Enabled and Disabled. See ITU-T<br> Recs. X.731 and M.3100 for details.<br>Default Value – Actual state of resource at the time<br> the object is created. If there is a period of time<br> during the initialization process where the<br> operational state is unknown, then the resource will<br>be considered disabled until initialization has<br> completed and the state updated accordingly.<br>Constraints to Provisioning – N/A.<br>Effect of Change in Value – See ITU-T Recs. X.731 and M.3100.<br>This attribute is read-only.' }}},exdapi"+elementname+":{type: 'text',index: 2,group:'oduknim"+elementname+"',label: 'EX DAPI',attrs:{'input':{'data-tooltip':'The Expected Destination Access Point Identifier<br> (ExDAPI), provisioned by the managing system, to be<br> compared with the TTI accepted at the overhead<br> position of the sink for the purpose of checking the<br> integrity of connectivity. This attribute is<br> read-write.' }}},exsapi"+elementname+":{type: 'text',index: 3,group:'oduknim"+elementname+"',label: 'EX SAPI',attrs:{'input':{'data-tooltip':'The Expected Source Access Point Identifier<br>(ExSAPI), provisioned by the managing system, to be<br>compared with the TTI accepted at the overhead<br>position of the sink for the purpose of checking the<br> integrity of connectivity. This attribute is<br>read-write.'}}},acti"+elementname+":{type: 'text',index:4 ,group:'oduknim"+elementname+"',label: 'AC TI',attrs:{'input':{'data-tooltip':'The Trail Trace Identifier (TTI) information<br>recovered (Accepted) from the TTI overhead position<br>at the sink of a trail. This attribute is read-only.'}}},timdetmode"+elementname+":{type: 'select',options: ['off','dapi','sapi','both'],index: 5,group:'oduknim"+elementname+"',label: 'TIM DET Mode',attrs:{'label':{'data-tooltip':'This attribute indicates the mode of the Trace<br>Identifier Mismatch (TIM) Detection function. Valid<br>values are: off, dapi, sapi, both. This attribute is<br>read-write.' }}},timactdisabled"+elementname+":{type: 'toggle',index:6 ,group:'oduknim"+elementname+"',label: 'TIM ACT Disabled',attrs:{'input':{'data-tooltip':'This attribute provides the control capability for the<br>managing system to enable or disable the Consequent<br>Action function when detecting Trace Identifier Mismatch<br>(TIM) at the trail termination sink. The value of TRUE<br>means disabled. This attribute is read-write.'}}},degthr"+elementname+":{type: 'number',min: 0,max: 2147483647,index:7 ,group:'oduknim"+elementname+"',label: 'DEG THR',attrs:{'input':{'data-tooltip':'This attribute indicates the threshold level for<br>declaring a performance monitoring (PM) Second to be<br>bad. A PM Second is declared bad if the percentage<br>of detected errored blocks in that second is greater<br>than or equal to the specified threshold level.<brValid values are integers in units of percentages.<br>This attribute is read-write.'}}},degm"+elementname+":{type: 'number',min: 0,max: 2147483647,index: 8,group:'oduknim"+elementname+"',label: 'DEG M',attrs:{'input':{'data-tooltip':'This attribute indicates the threshold level for<br> declaring a Degraded Signal defect (dDEG). A dDEG<br>shall be declared if DegM consecutive bad PM Seconds<br>are detected. This attribute is read-write.'}}},currentproblemlist"+elementname+":{type: 'number',min: 1,	max: 127,index:9 ,group:'oduknim"+elementname+"',label: 'Current Problem List',attrs:{'input':{'data-tooltip':'This attribute indicates the failure conditions of the entity.<br>Possible values of this attribute include decimal <br> numbers between 1 and 31, representing:<br>1)no defect;<br>2)TIM (Trail Trace Identifier Mismatch);<br>3) DEG (Signal Degraded);<br>4) BDI (Backward Defect Indication);<br>5) SSF (Server Signal Fail).<br>This attribute is read-only.' }}},nimdirectionality"+elementname+":{type: 'select',options: ['sink','source'],index:10 ,group:'oduknim"+elementname+"',label: 'NIM directionality',attrs:{'label':{'data-tooltip':'This attribute indicates the directionality of the ODUk<br> Path non-intrusive monitoring function. Valid values are<br> sink and source. This attribute is significant for ODUk<br> Path unidirectional non-intrusive monitoring when the<br> associated ODUk_CTP is bidirectional. This attribute is<br> read-only.'}}},";
				...
				var elementname = index;
				var input = "k"+elementname+":{type: 'range',min: 1,max: 3,step: 1,group: 'odukttp"+elementname+"',label: 'k',attrs:{'input':{'data-tooltip':'This attribute specifies the index k that is used<br>to represent a supported bit rate and the different<br>versions of OPUk, ODUk and OTUk. Valid values for<br>this attribute are integers 1, 2 and 3.<br>k = 1 represents an approximate bit rate of 2.5 Gbit/s;<br>k = 2 represents an approximate bit rate of 10 Gbit/s; and<br>k = 3 represents an approximate bit rate of 40 Gbit/s.<br>This attribute is read-only.' }}},operationalstate"+elementname+""+elementname+":{type: 'select',options: ['enabled','disabled'],group: 'odukttp"+elementname+"',label: 'Operational State',attrs:{'label':{'data-tooltip':'This attribute is generally defined in ITU-T Rec.<br>X.731 and the behaviour description for<br>operationalstate"+elementname+""+elementname+" in ITU-T Rec. M.3100.<br>Possible Values – Enabled and Disabled. See ITU-T<br>Recs. X.731 and M.3100 for details.<br>Default Value – Actual state of resource at the time<br>the object is created. If there is a period of time<br>during the initialization process where the<br>operational state is unknown, then the resource will<br>be considered disabled until initialization has<br>completed and the state updated accordingly.<br>Constraints to Provisioning – N/A.<br>Effect of Change in Value – See ITU-T Recs. X.731 and M.3100.<br>This attribute is read-only.'}}},directionality"+elementname+":{type: 'select',options: ['sink','source','bidirectional'],group: 'odukttp"+elementname+"',label: 'directionality ',attrs:{'label':{'data-tooltip':'This attribute indicates the directionality of the<br>termination point. Valid values are sink, source,<br>and bidirectional. This attribute is read-only.'}}},txti"+elementname+":{type: 'text',group: 'odukttp"+elementname+"',label: 'TX TI',attrs:{'input':{'data-tooltip':'The Trail Trace Identifier (TTI) information,<br>provisioned by the managing system at the<br>termination source, to be placed in the TTI overhead<br>position of the source of a trail for transmission.<br>This attribute is read-write.'}}},exdapi"+elementname+":{type: 'text',group: 'odukttp"+elementname+"',label: 'EX DAPI',attrs:{'input':{'data-tooltip':'The Expected Destination Access Point Identifier<br>(ExDAPI), provisioned by the managing system, to be<br>compared with the TTI accepted at the overhead<br>position of the sink for the purpose of checking the<br>integrity of connectivity. This attribute is<br>read-write.'}}},		exsapi"+elementname+":{type: 'text',group: 'odukttp"+elementname+"',label: 'EX SAPI',attrs:{'input':{'data-tooltip':'The Expected Source Access Point Identifier<br>(ExSAPI), provisioned by the managing system, to be<br>compared with the TTI accepted at the overhead<br>position of the sink for the purpose of checking the<br>integrity of connectivity. This attribute is<br>read-write.'}}},acti"+elementname+":{type: 'text',group: 'odukttp"+elementname+"',label: 'AC TI',attrs:{'input':{'data-tooltip': 'The Trail Trace Identifier (TTI) information<br>recovered (Accepted) from the TTI overhead position<br>at the sink of a trail. This attribute is read-only.'}}},		timdetmode"+elementname+":{type: 'select',options: ['off','dapi','sapi','both'],group: 'odukttp"+elementname+"',label: 'TIM DET Mode',attrs:{'label':{'data-tooltip':'This attribute indicates the mode of the Trace<br>Identifier Mismatch (TIM) Detection function. Valid<br>values are: off, dapi, sapi, both. This attribute is<br>read-write.'}}},timactdisabled"+elementname+":{type: 'toggle',group: 'odukttp"+elementname+"',label: 'TIM ACT Disabled',attrs:{'input':{'data-tooltip':'This attribute provides the control capability for the<br>managing system to enable or disable the Consequent<br>Action function when detecting Trace Identifier Mismatch<br>(TIM) at the trail termination sink. The value of TRUE<br>means disabled. This attribute is read-write.'}}},degthr"+elementname+":{type: 'number',min: 0,max: 2147483647,group: 'odukttp"+elementname+"',label: 'DEG THR',attrs:{'input':{'data-tooltip':'This attribute indicates the threshold level for<br>declaring a performance monitoring (PM) Second to be<br>bad. A PM Second is declared bad if the percentage<br>of detected errored blocks in that second is greater<br>than or equal to the specified threshold level.<br>Valid values are integers in units of percentages.<br>This attribute is read-write.'}}},degm"+elementname+":{type: 'number',min: 0,max: 2147483647,group: 'odukttp"+elementname+"',label: 'DEG M',attrs:{'input':{'data-tooltip':'This attribute indicates the threshold level for<br>declaring a Degraded Signal defect (dDEG). A dDEG<br>shall be declared if DegM consecutive bad PM Seconds<br>are detected. This attribute is read-write.'}}},				positionseg"+elementname+":{type: 'number',min: 0,max: 2147483647,group: 'odukttp"+elementname+"',label: 'Position Seg',attrs:{'input':{'data-tooltip':'This attribute indicates the positions of the TCM<br>and GCC processing functions within the ODUk TP.<br>The order of the position in the positionSeq<br>attribute together with the signal flow determine<br>the processing sequence of the TCM and GCC functions<br>within the ODUk TP. Once the positions are<br>determined, the signal processing sequence will<br>follow the signal flow for each direction of the<br> signal.<br>Within the ODUk_CTP, the position order is going<br>from adaptation to connection function. Within the<br>ODUk_TTP, the order is going from connection to<br>adaptation function.<br>The syntax of the PositionSeq attribute will be a<br>SEQUENCE OF pointers, which point to the contained<br>TCM and GCC function.<br>The order of TCM and GCC access function in the<br>positionSeq attribute is significant only when there<br>are more than one TCM functions within the ODUk TP<br>and also at least one of them have the<br>TimActDisabled attribute set to FALSE (i.e. AIS is<br>inserted upon TIM).<br>If a GCC12_TP is contained in an ODUk_TTP and the<br>GCC12_TP is not listed in the PositionSeq attribute<br>of the ODUk_TTP, then the GCC access is at the AP<br>side of the ODUk TT function.<br>This attribute is read-only.'}}},currentproblemlist"+elementname+":{type: 'number',min: 1,max: 127,group: 'odukttp"+elementname+"',label: 'Current Problem List',attrs:{'input':{'data-tooltip':'This attribute indicates the failure conditions of the entity.<br>Possible values of this attribute include decimal <br> numbers between 1 and 31, representing:<br>1)no defect;<br>2)TIM (Trail Trace Identifier Mismatch);<br>3) DEG (Signal Degraded);<br>4) BDI (Backward Defect Indication);<br>5) SSF (Server Signal Fail).<br>This attribute is read-only.'}}},tcmfieldsinuse:{type: 'number',min: 0,max: 2147483647,group: 'odukttp"+elementname+"',label: 'TCM Fields In Use',attrs:{'input':{'data-tooltip':'This attribute indicates the used TCM fields of the<br>ODUk OH. Valid values of this attribute are integers between 1 and 63 This attribute is read-only.'}}},";
				...
				var elementname = index;
				var input = "tcmfield:{type: 'range',min: 1,max: 6,step: 1,group:'oduktnim"+elementname+"',label: 'TCM Field',attrs:{'input':{'data-tooltip':'This attribute indicates the tandem connection<br> monitoring field of the ODUk OH. Valid values are<br> integers from 1 to 6. This attribute is read-only.'}}},operationalstate"+elementname+""+elementname+":{type: 'select',options: ['enabled','disabled'],group:'oduktnim"+elementname+"',label: 'Operational State',attrs:{'label':{'data-tooltip':'This attribute is generally defined in ITU-T Rec.<br> X.731 and the behaviour description for<br> operationalstate"+elementname+""+elementname+" in ITU-T Rec. M.3100.<br>Possible Values – Enabled and Disabled. See ITU-T<br> Recs. X.731 and M.3100 for details.<br>Default Value – Actual state of resource at the time<br> the object is created. If there is a period of time<br> during the initialization process where the<br>operational state is unknown, then the resource will<br> be considered disabled until initialization has<br> completed and the state updated accordingly.<br>Constraints to Provisioning – N/A.<br>Effect of Change in Value – See ITU-T Recs. X.731 and M.3100.<br>This attribute is read-only.'}}},exdapi"+elementname+":{type: 'text',group:'oduktnim"+elementname+"',label: 'EX DAPI',attrs:{'input':{'data-tooltip':'The Expected Destination Access Point Identifier<br> (ExDAPI), provisioned by the managing system, to be<br> compared with the TTI accepted at the overhead<br> position of the sink for the purpose of checking the<br> integrity of connectivity. This attribute is<br> read-write.'}}},exsapi"+elementname+":{type: 'text',group:'oduktnim"+elementname+"',label: 'EX SAPI',attrs:{'input':{'data-tooltip':'The Expected Source Access Point Identifier<br> (ExSAPI), provisioned by the managing system, to be<br> compared with the TTI accepted at the overhead<br> position of the sink for the purpose of checking the<br> integrity of connectivity. This attribute is<br> read-write.'}}},acti"+elementname+":{type: 'text',group:'oduktnim"+elementname+"',label: 'AC TI',attrs:{'input':{'data-tooltip':'The Trail Trace Identifier (TTI) information<br> recovered (Accepted) from the TTI overhead position<br> at the sink of a trail. This attribute is read-only.'}}},timdetmode"+elementname+":{type: 'select',options: ['off','dapi','sapi','both'],group:'oduktnim"+elementname+"',label: 'TIM DET Mode',attrs:{'label':{'data-tooltip':'This attribute indicates the mode of the Trace<br> Identifier Mismatch (TIM) Detection function. Valid<br> values are: off, dapi, sapi, both. This attribute is<br> read-write.'}}},timactdisabled"+elementname+":{type: 'toggle',group:'oduktnim"+elementname+"',label: 'TIM ACT Disabled',attrs:{'input':{'data-tooltip': 'This attribute provides the control capability for the<br> managing system to enable or disable the Consequent<br> Action function when detecting Trace Identifier Mismatch<br> (TIM) at the trail termination sink. The value of TRUE<br>means disabled. This attribute is read-write.'}}},degthr"+elementname+":{type: 'number',min: 0,max: 2147483647,group:'oduktnim"+elementname+"',label: 'DEG THR',attrs:{'input':{'data-tooltip':'This attribute indicates the threshold level for<br>declaring a performance monitoring (PM) Second to be<br>bad. A PM Second is declared bad if the percentage<br>of detected errored blocks in that second is greater<br>than or equal to the specified threshold level.<br>Valid values are integers in units of percentages.<br>This attribute is read-write.'}}},degm"+elementname+":{type: 'number',min: 0,max: 2147483647,group:'oduktnim"+elementname+"',label: 'DEG M',attrs:{'input':{'data-tooltip':'This attribute indicates the threshold level for<br>declaring a Degraded Signal defect (dDEG). A dDEG<br>shall be declared if DegM consecutive bad PM Seconds<br>are detected. This attribute is read-write.'}}},nimdirectionality"+elementname+":{type: 'select',options: ['sink','source'],group:'oduktnim"+elementname+"',label: 'NIM directionality',attrs:{'label':{'data-tooltip':'This attribute indicates the directionality of the ODUk<br>Path non-intrusive monitoring function. Valid values are<br>sink and source. This attribute is significant for ODUk<br>Path unidirectional non-intrusive monitoring when the<br>associated ODUk_CTP is bidirectional. This attribute is<br>read-only.'}}},currentproblemlist"+elementname+":{type: 'number',min: 1,max: 127,group:'oduktnim"+elementname+"',label: 'Current Problem List',attrs:{'input':{'data-tooltip':'This attribute indicates the failure conditions of the entity.<br>Possible values of this attribute include decimal <br> numbers between 1 and 31, representing:<br>1)no defect;<br>2)TIM (Trail Trace Identifier Mismatch);<br>3) DEG (Signal Degraded);<br>4) BDI (Backward Defect Indication);<br>5) SSF (Server Signal Fail).<br>This attribute is read-only.' }}},";
				...
				var elementname = index;
				var input = "directionality"+elementname+":{type: 'select',options: ['sink','source','bidirectional'],group:'omsnctp"+elementname+"',label: 'directionality ',attrs:{'label':{'data-tooltip':'This attribute indicates the directionality of the<br>termination point. Valid values are sink, source,<br>and bidirectional. This attribute is read-only.'}}},		";
				...
				var elementname = index;
				var input = "directionality"+elementname+":{type: 'select',options: ['sink','source','bidirectional'],label: 'directionality ',group : 'omsnttp"+elementname+"',attrs:{'label':{'data-tooltip':'This attribute indicates the directionality of the<br>	termination point. Valid values are sink, source,<br>and bidirectional. This attribute is read-only.'}}},operationalstate"+elementname+""+elementname+":{type: 'select',options: ['enabled','disabled'],label: 'Operational State',group : 'omsnttp"+elementname+"',attrs:{'label':{'data-tooltip':'This attribute is generally defined in ITU-T Rec. <br>X.731 and the behaviour description for<br>operationalstate"+elementname+""+elementname+" in ITU-T Rec. M.3100.<br>						Possible Values – Enabled and Disabled. See ITU-T<br>Recs. X.731 and M.3100 for details.<br>Default Value – Actual state of resource at the time<br>the object is created. If there is a period of time<br>during the initialization process where the<br> operational state is unknown, then the resource will <br>be considered disabled until initialization has <br>						completed and the state updated accordingly.<br>						Constraints to Provisioning – N/A.<br>Effect of Change in Value – See ITU-T Recs. X.731 and M.3100.<br>This attribute is read-only.'}}},currentproblemlist"+elementname+":{type: 'number',min: 1,max: 255,label: 'Current Problem List',group : 'omsnttp"+elementname+"',attrs:{'input':{'data-tooltip':'This attribute indicates the failure conditions of the entity.<br>Possible values of this attribute include decimal <br> numbers between 1 and 31, representing:<br>1)no defect;<br>2)TIM (Trail Trace Identifier Mismatch);<br>3) DEG (Signal Degraded);<br>4) BDI (Backward Defect Indication);<br>5) SSF (Server Signal Fail).<br>This attribute is read-only.' }}},";
				...
				var elementname = index;
				var input = "directionality"+elementname+": {type: 'select',options: ['sink','source','bidirectional'],label: 'directionality ',group:'opsnttp"+elementname+"',attrs:{'label':{'data-tooltip': 'This attribute indicates the directionality of the<br> termination point. Valid values are sink, source,<br>and bidirectional. This attribute is read-only.'}}},operationalstate"+elementname+""+elementname+":{type: 'select',options: ['enabled','disabled'],label: 'Operational State',group:'opsnttp"+elementname+"',attrs:{'label':{'data-tooltip':'This attribute is generally defined in ITU-T Rec.<br> X.731 and the behaviour description for <br>operationalstate"+elementname+""+elementname+" in ITU-T Rec. M.3100.<br>Possible Values – Enabled and Disabled. See ITU-T <br>Recs. X.731 and M.3100 for details.<br>	Default Value – Actual state of resource at the time<br> the object is created. If there is a period of time<br> during the initialization process where the<br> operational state is unknown, then the resource will <br>be considered disabled until initialization has<br> completed and the state updated accordingly.<br>Constraints to Provisioning – N/A.<br>Effect of Change in Value – See ITU-T Recs. X.731 and M.3100.<br>This attribute is read-only.'}}},currentproblemlist"+elementname+":{type: 'number',min: 1,max: 3,label: 'Current Problem List',group:'opsnttp"+elementname+"',attrs:{'input':{'data-tooltip':'This attribute indicates the failure conditions of the entity.<br>Possible values of this attribute include decimal <br> numbers between 1 and 31, representing:<br>1)no defect;<br>2)TIM (Trail Trace Identifier Mismatch);<br>3) DEG (Signal Degraded);<br>4) BDI (Backward Defect Indication);<br>5) SSF (Server Signal Fail).<br>This attribute is read-only.'}}},";
				...
				var elementname = index;
				var input = "directionality"+elementname+":{type: 'select',options: ['sink','source','bidirectional'],label: 'directionality ',group:'otsnttp"+elementname+"',attrs:{'label':{'data-tooltip':'This attribute indicates the directionality of the<br> termination point. Valid values are sink, source,<br> and bidirectional. This attribute is read-only.'}}},operationalstate"+elementname+""+elementname+":{type: 'select',options: ['enabled','disabled'],label: 'Operational State',group:'otsnttp"+elementname+"',attrs:{'label':{'data-tooltip': 'This attribute is generally defined in ITU-T Rec.<br> X.731 and the behaviour description for<br> operationalstate"+elementname+""+elementname+" in ITU-T Rec. M.3100.<br>Possible Values – Enabled and Disabled. See ITU-T <br>	Recs. X.731 and M.3100 for details.<br>	Default Value – Actual state of resource at the time<br> the object is created. If there is a period of time<br> during the initialization process where the <br>operational state is unknown, then the resource will<br> be considered disabled until initialization has<br> completed and the state updated accordingly.<br>Constraints to Provisioning – N/A.<br>	Effect of Change in Value – See ITU-T Recs. X.731 and M.3100.<br>This attribute is read-only.'}}},aprstatus"+elementname+":{type: 'text',label: 'APR Status',group:'otsnttp"+elementname+"',attrs:{'input':{'data-tooltip':'This attribute indicates the status of the<br> Automatic Power Reduction (APR) function of the <br>entity. Valid values are on and off. This <br>	attribute is read-only.'}}},aprcntrl"+elementname+":{type: 'text',label: 'APR CNTRL',group:'otsnttp"+elementname+"',attrs:{'input':{'data-tooltip':'This attribute provides for the control of the<br> Automatic Power Reduction (APR) function of the<br> entity. The specific APR procedures and trigger<br> criteria of APR is outside the scope of this <br> Recommendation. This attribute is optional. This <br> attribute is read-write.'}}},		txti"+elementname+":{type: 'text',label: 'TX TI',group:'otsnttp"+elementname+"',attrs:{'input':{'data-tooltip':'The Trail Trace Identifier (TTI) information,<br> provisioned by the managing system at the<br> termination source, to be placed in the TTI overhead<br> position of the source of a trail for transmission.<br> This attribute is read-write.'}}},exdapi"+elementname+":{type: 'text',label: 'EX DAPI',group:'otsnttp"+elementname+"',attrs:{'input':{'data-tooltip':'The Expected Destination Access Point Identifier<br>(ExDAPI), provisioned by the managing system, to be<br> compared with the TTI accepted at the overhead<br> position of the sink for the purpose of checking the<br> integrity of connectivity. This attribute is<br> read-write.'}}},exsapi"+elementname+":{type: 'text',label: 'EX SAPI',group:'otsnttp"+elementname+"',attrs:{'input':{'data-tooltip':'The Expected Source Access Point Identifier<br> (ExSAPI), provisioned by the managing system, to be<br> compared with the TTI accepted at the overhead<br>	position of the sink for the purpose of checking the<br> integrity of connectivity. This attribute is<br> read-write.'}}},acti"+elementname+":{type: 'text',label: 'AC TI',group:'otsnttp"+elementname+"',attrs:{'input':{'data-tooltip':'The Trail Trace Identifier (TTI) information<br> recovered (Accepted) from the TTI overhead position<br> at the sink of a trail. This attribute is read-only.'}}},timdetmode"+elementname+":{type: 'select',options: ['off', 'dapi', 'sapi','both'],label: 'TIM DET Mode',group:'otsnttp"+elementname+"',attrs:{'label':{'data-tooltip':'This attribute indicates the mode of the Trace<br> Identifier Mismatch (TIM) Detection function. Valid<br> values are: off, dapi, sapi, both. This attribute is<br> read-write.'}}},timactdisabled"+elementname+":{type: 'toggle',label: 'TIM ACT Disabled',group:'otsnttp"+elementname+"',attrs:{'input':{'data-tooltip':'This attribute provides the control capability for the<br> managing system to enable or disable the Consequent <br>Action function when detecting Trace Identifier Mismatch<br> (TIM) at the trail termination sink. The value of TRUE<br> means disabled. This attribute is read-write.'}}},currentproblemlist"+elementname+":{type: 'range',min: 1,max: 255,step: 1,label: 'Current Problem List',group:'otsnttp"+elementname+"',attrs:{'input':{'data-tooltip':'This attribute indicates the failure conditions of the entity.<br>Possible values of this attribute include decimal <br> numbers between 1 and 31, representing:<br>1)no defect;<br>2)TIM (Trail Trace Identifier Mismatch);<br>3) DEG (Signal Degraded);<br>4) BDI (Backward Defect Indication);<br>5) SSF (Server Signal Fail).<br>This attribute is read-only.' }}},";
				...
				var elementname = index;
				var input = "k"+elementname+":{type: 'range',min: -1,max: 4,step: 1,group:'otukctp"+elementname+"',label: 'k',attrs:{'input':{'data-tooltip':'This attribute specifies the index k that is used<br> to represent a supported bit rate and the different<br> versions of OPUk, ODUk and OTUk. Valid values for<br> this attribute are integers 1, 2 and 3.<br>	k = 1 represents an approximate bit rate of 2.5 Gbit/s;<br>	k = 2 represents an approximate bit rate of 10 Gbit/s; and<br>	k = 3 represents an approximate bit rate of 40 Gbit/s.<br>This attribute is read-only.'}}},sinkadaptactive"+elementname+":{type: 'toggle',group:'otukctp"+elementname+"',label: 'Sink Adapt Active',attrs:{'input':{'data-tooltip':'This attribute allows for activation or<br> deactivation the sink adaptation function. The value<br> of TRUE means active. This attribute is read-write.' }}},sourceadaptactive"+elementname+":{type: 'toggle',group:'otukctp"+elementname+"',label: 'Source Adapt Active',attrs:{'input':{'data-tooltip':'This attribute allows for activion or deactivation<br> the source adaptation function. The value of TRUE<br> means activate. This attribute is read-write.'}}},fecenabled"+elementname+":{type: 'toggle',group:'otukctp"+elementname+"',label:'FEC Enabled',attrs:{'input':{'data-tooltip':'If Forward Error Correction (FEC) is supported,<br> this object indicates whether FEC at the OTUk sink <br> adaptation function is enabled or not. This <br> attribute is optional. Valid values are TRUE and<br> FALSE. TRUE means FEC is enabled. This attribute is<br> read-write.'}}},directionality"+elementname+":{type: 'select',options: ['sink','source','bidirectional'],group:'otukctp"+elementname+"',label: 'directionality ',attrs:{'label':{'data-tooltip':'This attribute indicates the directionality of the<br> termination point. Valid values are sink, source,<br> and bidirectional. This attribute is read-only.'}}},currentproblemlist"+elementname+":{type: 'number',min: 1,max: 15,group:'otukctp"+elementname+"',label: 'Current Problem List',attrs:{'input':{'data-tooltip':'This attribute indicates the failure conditions of the entity.<br>Possible values of this attribute include decimal <br> numbers between 1 and 31, representing:<br>1)no defect;<br>2)TIM (Trail Trace Identifier Mismatch);<br>3) DEG (Signal Degraded);<br>4) BDI (Backward Defect Indication);<br>5) SSF (Server Signal Fail).<br>This attribute is read-only.' }}},";
