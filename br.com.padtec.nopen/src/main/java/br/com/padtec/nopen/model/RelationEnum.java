...
public enum RelationEnum {
	...
	ComponentOf19_Physical_Media_PM_Input_So("ComponentOf19"),
	links_output("links_output"),
	connects("connects"),
	INV_links_input_FEP_PM_Input_So("INV.links_input.FEP.PM_Input_So"),
	ComponentOf7_Technology_Layer("ComponentOf7"),
	ComponentOf9_Shelf_Slot("ComponentOf9"),
	ComponentOf16_Transport_Function_Input("ComponentOf16"),
	INV_ComponentOf19_PM_Input_So_Physical_Media("INV.ComponentOf19"),
	ComponentOf14_Adaptation_Function_Adaptation_Function_Input("ComponentOf14"),
	...
	INV_ComponentOf10_Supervisor_Slot("INV.ComponentOf10"),
	implements_Layer_Service("implements.Layer.Service"),
	INV_links_input("INV.links_input"),
	INV_ComponentOf_Input_Card_Card("INV.ComponentOf"),
	INV_manages_Equipment_Supervisor("INV.manages"),
	...
	INV_ComponentOf20_Trail_Termination_Function_Output_Trail_Termination_Function("INV.ComponentOf20"),
	is_client_Layer_Layer("is_client"),
	INV_links_input_FP_Adaptation_Function_Input("INV.links_input.FP.Adaptation_Function_Input"),
	INV_is_client_Layer_Layer("INV.is_client"),
	binds("binds"),
	...
	ComponentOf10_Slot_Supervisor("ComponentOf10"),
	...
	ComponentOf1_Card_TF_Card_Element("ComponentOf1"),
	INV_ComponentOf2_Output_Card_Card("INV.ComponentOf2"),
	INV_ComponentOf5_Card_Subslot("INV.ComponentOf5"),
	INV_ComponentOf9_Slot_Shelf("INV.ComponentOf9"),
	INV_ComponentOf7_Layer_Technology("INV.ComponentOf7"),
	INV_ComponentOf11_Subslot_Slot("INV.ComponentOf11"),
	ComponentOf4_Slot_Card("ComponentOf4"),
	INV_ComponentOf13_Matrix_Input_Matrix("INV.ComponentOf13"),
	ComponentOf6_Layer_Trail_Termination_Function("ComponentOf6"),
	ComponentOf13_Matrix_Matrix_Input("ComponentOf13"),
	...
	ComponentOf18_Physical_Media_PM_Input_Sk("ComponentOf18"),
	mc_FP_FEP("mc"),
	connects_FP_FP("connects.FP.FP"),
	INV_links_input_FEP_Adaptation_Function_Input("INV.links_input.FEP.Adaptation_Function_Input"),
	INV_Material_Card_Supervisor("INV.Material"),
	INV_has_path_Reference_Point_Reference_Point("INV.has_path"),
	...
	ComponentOf21_Trail_Termination_Function_Trail_Termination_Function_Input("ComponentOf21"),
	INV_ComponentOf12_Matrix_Output_Matrix("INV.ComponentOf12"),
	ComponentOf11_Slot_Subslot("ComponentOf11"),
	links_input_FEP_PM_Input_Sk("links_input.FEP.PM_Input_Sk"),
	manages_Supervisor_Equipment("manages"),
	...
	INV_ComponentOf14_Adaptation_Function_Input_Adaptation_Function("INV.ComponentOf14"),
	INV_binds("INV.binds"),
	INV_connects_FP_FP("INV.connects.FP.FP"),
	ComponentOf_Card_Input_Card("ComponentOf"),
	INV_mc_FEP_FP("INV.mc"),
	has_path_Reference_Point_Reference_Point("has_path"),
	INV_ComponentOf1_TF_Card_Element_Card("INV.ComponentOf1"),
	ComponentOf8_Rack_Shelf("ComponentOf8"),
	INV_has_connects_supported_Reference_Point_Reference_Point("INV.has_connects_supported"),
	ComponentOf17_Transport_Function_Output("ComponentOf17"),
	...
	ComponentOf15_Adaptation_Function_Adaptation_Function_Output("ComponentOf15"),
	...
	INV_ComponentOf4_Card_Slot("INV.ComponentOf4"),
	INV_ComponentOf6_Trail_Termination_Function_Layer("INV.ComponentOf6"),
	INV_ComponentOf8_Shelf_Rack("INV.ComponentOf8"),
	INV_links_input_FEP_PM_Input_Sk("INV.links_input.FEP.PM_Input_Sk"),
	ComponentOf3_Card_Layer("ComponentOf3"),
	ComponentOf5_Subslot_Card("ComponentOf5"),
	ComponentOf12_Matrix_Matrix_Output("ComponentOf12"),
	Material_Supervisor_Card("Material"),
	INV_ComponentOf15_Adaptation_Function_Output_Adaptation_Function("INV.ComponentOf15"),
	INV_ComponentOf17_Output_Transport_Function("INV.ComponentOf17"),
	links_input_AP_Trail_Termination_Function_Input("links_input.AP.Trail_Termination_Function_Input"),
	ComponentOf20_Trail_Termination_Function_Trail_Termination_Function_Output("ComponentOf20"),
	...
	INV_ComponentOf18_PM_Input_Sk_Physical_Media("INV.ComponentOf18"),
	INV_links_input_AP_Trail_Termination_Function_Input("INV.links_input.AP.Trail_Termination_Function_Input"),
	INV_ComponentOf21_Trail_Termination_Function_Input_Trail_Termination_Function("INV.ComponentOf21"),
	INV_implements_Layer_Service("INV.implements.Layer.Service"),
	INV_ComponentOf16_Input_Transport_Function("INV.ComponentOf16"),
	...
	INV_ComponentOf3_Layer_Card("INV.ComponentOf3"),
	ComponentOf2_Card_Output_Card("ComponentOf2");
