...
public class QueryManager {
	...
	public static String getRelationsComingOutOf(String centerNode){
		String query = 
	...
	public static String getRelationsComingInOf(String centerNode){
		String query = 
				"PREFIX owl: <http://www.w3.org/2002/07/owl#> " +
						"PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>" +
						"PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> " +
...
//		query = "PREFIX owl: <http://www.w3.org/2002/07/owl#> PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> SELECT DISTINCT * WHERE {			<http://cohse.semanticweb.org/ontologies/people#Mick> ?property ?target 	}";
	...
	public static String getAllClassesFor(String indv) {
		String query = 
			  "PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>"
			+ "PREFIX owl: <http://www.w3.org/2002/07/owl#>"
			+ "PREFIX xsd: <http://www.w3.org/2001/XMLSchema#>"
